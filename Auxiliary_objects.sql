-- Tabulka ekonomických ukazatelù t_economy_data
...
-- Tabulka èasových ukazatelù t_time_data
...
-- Tabulka se zmìnou oèekávané doby dožití t_life_expectancy_data
...
-- Tabulka provedených testù t_covid19_tests_data
...
-- Tabulka vybraných ukazatelù jednotlivých zemí t_country_data
...
-- Tabulka optimalizovaných klíèù t_keys
